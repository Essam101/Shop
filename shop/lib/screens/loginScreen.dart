...
import 'package:shop/widgets/textformfield.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  TextEditingController emailController = TextEditingController(text:"essamsaleh101" );
  TextEditingController passwordController = TextEditingController(text: "Essam 101");
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              Navigator.of(context).pushNamed(registerStoreScreen);
